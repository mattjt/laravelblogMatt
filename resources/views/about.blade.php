...
@section('content')
    ...
    <div class="w-4/5 m-auto sm:grid grid-cols-2 gap-10 py-10">
        <div>
            <img src="\images\about.jpg" alt="About Image" class=" rounded-lg shadow-2xl">
        </div>
        <div class="flex flex-col justify-center">
            ...
            <a href="/contact" class="bg-red-500 text-white font-bold py-3 px-6 rounded-lg shadow-2xl hover:bg-red-700 transition">Get in Touch</a>
        </div>
    </div>
