...
@section('content')
    <div class="bg-gray-800 py-15 shadow-2xl">
    ...
    <div class="w-4/5 m-auto sm:grid grid-cols-2 gap-10 py-10">
        <div>
            <img src="\images\contactus.jpg" alt="Contact Image" class="rounded-lg shadow-2xl">
        </div>
        <div class="flex flex-col justify-center">
            ...
            <form action="{{ route('contact.submit') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
                ...
                <button type="submit" class="bg-red-500 text-white font-bold py-3 px-6 rounded-lg shadow-2xl hover:bg-red-700 transition">Send Message</button>
            </form>
        </div>
    </div>

    <div class="bg-gray-500 text-white py-20 text-center shadow-2xl">
